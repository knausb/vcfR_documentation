...
Once we have an idea of what the data look like, we'll see how we can censor data that we determine to be unusual.
...
We've generated a box and whisker plot for each sample where 50% of the data is contained within each colored box and outliers are presented at circles.
...
## Censoring variants of unusual depth


We see from our plot that there is a considerable amount of variation in depth within each sample.
...
A number off methods can be used to create intervals that you may consider acceptable.
...
Now see how this has affected missingness in our vcfR object.
...
We've now used our depth information to censor variants that we feel are of unusual sequence depth.
