...
bibliography: vcfR_documentation.bib
---
...
This is the probability that two alleles randomly chosen from a population will be different.
...
This was later extended to a method based of diversity by Masatoshi Nei [@nei1973analysis].
...
And there are more variants than I've mentioned here.
A nice discussion as to which measure may be appropriate for your data was posted to the Molecular Ecologist blog titled [should I use $F_{ST}$, $G_{ST}$ or $D$?](http://www.molecularecologist.com/2011/03/should-i-use-fst-gst-or-d-2/).


In `vcfR` I've implemented the function `genetic_diff()` to measure population diversity and differentiation.
