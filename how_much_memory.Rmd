...
for(i in nvar){
  nMb <- c(nMb, howbig(nrow=i, ncol=10, unit="KB"))
}
nvar <- c(10, nvar)

nMb <- as.numeric(lapply(nMb, as.numeric))/1000
...
axis(side = 2, at = 0:7, labels=c('800k', '6.4Mb', '64Mb', '640Mb', '6.4Gb', '64Gb', '640Gb', '6.4Tb'), las=2)
